...
var CarouselArticleWebPart = /** @class */ (function (_super) {
    __extends(CarouselArticleWebPart, _super);
    function CarouselArticleWebPart() {
    ...
    CarouselArticleWebPart.prototype.render = function () {
        var element = React.createElement(CarouselArticle, {
    ...
    CarouselArticleWebPart.prototype.onInit = function () {
    ...
    CarouselArticleWebPart.prototype._fetchSitesForPropertyPane = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sites, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CarouselArticleWebPart.prototype._getEnvironmentMessage = function () {
        var _this = this;
    ...
    CarouselArticleWebPart.prototype.onThemeChanged = function (currentTheme) {
        if (!currentTheme) {
            return;
        }
    ...
    CarouselArticleWebPart.prototype.onDispose = function () {
        ReactDom.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(CarouselArticleWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    CarouselArticleWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
    ...
    return CarouselArticleWebPart;
}(BaseClientSideWebPart));
export default CarouselArticleWebPart;
//# sourceMappingURL=CarouselArticleWebPart.js.map