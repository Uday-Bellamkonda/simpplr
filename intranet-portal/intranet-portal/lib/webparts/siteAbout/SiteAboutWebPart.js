...
var SiteAboutWebPart = /** @class */ (function (_super) {
    __extends(SiteAboutWebPart, _super);
    function SiteAboutWebPart() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._isDarkTheme = false;
        _this._environmentMessage = '';
        return _this;
    }
    SiteAboutWebPart.prototype.render = function () {
        var element = React.createElement(SiteAbout, {
    ...
    SiteAboutWebPart.prototype.onInit = function () {
    ...
    SiteAboutWebPart.prototype._getEnvironmentMessage = function () {
        var _this = this;
    ...
    SiteAboutWebPart.prototype.onThemeChanged = function (currentTheme) {
        if (!currentTheme) {
            return;
        }
    ...
    SiteAboutWebPart.prototype.onDispose = function () {
        ReactDom.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(SiteAboutWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    SiteAboutWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
    ...
    return SiteAboutWebPart;
}(BaseClientSideWebPart));
export default SiteAboutWebPart;
//# sourceMappingURL=SiteAboutWebPart.js.map