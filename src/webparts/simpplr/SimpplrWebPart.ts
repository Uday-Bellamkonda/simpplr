...
import Simpplr from './components/Simpplr';
import { ISimpplrProps } from './components/ISimpplrProps';
...
export default class SimpplrWebPart extends BaseClientSideWebPart<ISimpplrWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISimpplrProps> = React.createElement(
      Simpplr,
      {
